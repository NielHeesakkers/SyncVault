...
**macOS** — [Download SyncVault-3.7.0.dmg](https://github.com/NielHeesakkers/SyncVault/releases/download/v3.7.0/SyncVault-3.7.0.dmg) · [All releases](https://github.com/NielHeesakkers/SyncVault/releases) · [Changelog](internal/api/rest/changelog.txt)
