...
#ifndef SYNCVAULTFILEPROVIDER_SWIFT_H
#define SYNCVAULTFILEPROVIDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SyncVaultFileProvider",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21SyncVaultFileProvider22FileProviderEnumerator")
...
@class NSURL;
SWIFT_CLASS("_TtC21SyncVaultFileProvider21FileProviderExtension")
...
@class UTType;
@class NSNumber;
SWIFT_CLASS("_TtC21SyncVaultFileProvider16FileProviderItem")
